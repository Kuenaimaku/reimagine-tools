...
export default {
  ...
  computed: {
    ...
    total(){
      ...
      return Number.parseInt(Math.min(gunKnowledge + crushingTechnique + demonology, 8800));
    },
    classRank() {
      let gunKnowledge = this.expertise.gunKnowledge.value * 0.4;
      let crushingTechnique = this.expertise.crushingTechnique.value * 0.4;
      ...
      var b = a.toString();
      if (a === 0 || this.expertise.gunKnowledge.value > 3000 || this.expertise.crushingTechnique.value > 3000 || this.expertise.demonology.value > 1000) {
        return "Class 0 Rank 0";
      } else if (a >= 100) {
        return "Class " + b.charAt(0) + b.charAt(1) + " Rank " + b.charAt(2);
      } else if (a >= 10) {
